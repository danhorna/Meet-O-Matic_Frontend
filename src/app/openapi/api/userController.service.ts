...
import { Userevent } from '../model/models';
...
export class UserControllerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public userControllerSignUp(newUser?: NewUser, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<Userevent>;
    public userControllerSignUp(newUser?: NewUser, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<Userevent>>;
    public userControllerSignUp(newUser?: NewUser, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<Userevent>>;
    public userControllerSignUp(newUser?: NewUser, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        ...
        return this.httpClient.post<Userevent>(`${this.configuration.basePath}/signup`,
            newUser,
            {
                responseType: <any>responseType,
                withCredentials: this.configuration.withCredentials,
